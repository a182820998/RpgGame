...
{
    class GameSystem : IDisposable, IPresenter
    {
        ...
        public void StartGame()
        {
            while (true)
            {
                ...
                {
                    foreach (var character in _db.Characters.ToList())
                    {
                        ...
                        (
                            ...
                            character.Str, (character.Job.ExtraStr == 0) ? "" : " + " + character.Job.ExtraStr.ToString(),
                            character.Dex, (character.Job.ExtraDex == 0) ? "" : " + " + character.Job.ExtraDex.ToString(),
                            character.Con, (character.Job.ExtraCon == 0) ? "" : " + " + character.Job.ExtraCon.ToString(),
            ...
            while (true)
            {
                ...
                if (regex1.IsMatch(name))
                {
                    ...
                    while (true)
                    {
                        ...
                        if (query == "1")
                        {
                            foreach (var containerJob in _db.Jobs.ToList())
                            {
                        ...
                        else
                        {
                            ...
                            Regex regex2 = new Regex("^[1-" + count.ToString() + "].*?");
        ...
        private void CharacterFight()
        {
            ...
            while (true)
            {
                ...
                if (match.Success)
                {
                    var fighter = characters[Convert.ToInt32(match.Value) - 1];
                    fighter.Job = jobs.Find(job => job.Id == fighter.JobId);
                    var enemy = monsters[monsterType];
                    ...
                    while (characterHp != 0 && enemyHp != 0)
                    {
                        if (attackTurn == 1)
                        {
                            ...
                            _view.PrintFightLive(enemy.Name, fighter.Name, enemyStr, fighter.Job.AntagonisticBy[enemy], preAttackHp, characterHp);
                            attackTurn = 0;
                        }
                        else
                        {
                            ...
                            _view.PrintFightLive(fighter.Name, enemy.Name, characterStr, enemy.Job.AntagonisticBy[fighter], preAttackHp, enemyHp);
                            attackTurn = 1;
                        }
                    }
                        ...
                        fighter.Level < 5)
                    {
                        ...
                        while (point != 0)
                        {
                            ...
                            (
                                str, (fighter.Job.ExtraStr == 0) ? "" : " + " + fighter.Job.ExtraStr.ToString(),
                                dex, (fighter.Job.ExtraDex == 0) ? "" : " + " + fighter.Job.ExtraDex.ToString(),
                                con, (fighter.Job.ExtraCon == 0) ? "" : " + " + fighter.Job.ExtraCon.ToString(), point
                            );
                            string choice = _view.InputQuery();
                        ...
                        (
                            ...
                            fighter.Str, (fighter.Job.ExtraStr == 0) ? "" : " + " + fighter.Job.ExtraStr.ToString(),
                            fighter.Dex, (fighter.Job.ExtraDex == 0) ? "" : " + " + fighter.Job.ExtraDex.ToString(),
                            fighter.Con, (fighter.Job.ExtraCon == 0) ? "" : " + " + fighter.Job.ExtraCon.ToString(),
        ...
        private void DeleteCharacter()
        {
            ...
            while (true)
            {
                ...
                if (match.Success)
                {
                    var deleteCharacter = characters[Convert.ToInt32(match.Value) - 1];
            ...
            while (true)
            {
                ...
                if (match1.Success)
                {
                    ...
                    if (extraValues.Sum() < 4)
                    {
                        ...
                        var tempJob = jobs[Convert.ToInt32(query) - 1];
                        tempJob.Name = name;
        ...
        private void DeleteJob()
        {
            ...
            while (true)
            {
                ...
                {
                    var characters = _db.Characters.ToList();
                    var deleteJob = jobs[Convert.ToInt32(match.Value) - 1];

                    foreach (var containerCharacter in characters)
                    {
                    ...
                    foreach (var containerJob in jobs)
                    {
